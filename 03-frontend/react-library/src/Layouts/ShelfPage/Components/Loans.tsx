...
export const Loans = () => {
    ...
    useEffect(() => {
        const fetchUserCurrentLoans = async () => {
            ...
            if (authState && authState.isAuthenticated) {
                const userCurrentLoansUrl = `${process.env.REACT_APP_API}/books/secure/currentloans`;
    ...
    async function returnBook(bookId: number) {
        const returnBookUrl = `${process.env.REACT_APP_API}/books/secure/return/?bookId=${bookId}`;
        ...
        const responseReturnBook = await fetch(returnBookUrl, requestOptions);

        if (!responseReturnBook.ok) {
            throw new Error('Something went wrong!');
        }
        // to trigger useEffect if it's checked out or not
        setCheckout(!checkout);
    }

    async function renewLoan(bookId: number) {
        const renewLoanUrl = `${process.env.REACT_APP_API}/books/secure/renew/loan/?bookId=${bookId}`;
        ...
        const responseRenewLoan = await fetch(renewLoanUrl, requestOptions);

        if (!responseRenewLoan.ok) {
            throw new Error('Something went wrong!');
        }
        // to trigger useEffect if it's checked out or not
        setCheckout(!checkout);
    ...
    return (
        <div>
                                ...
                                <div className='row mt-3 mb-3'>
                                    ...
                                    <div className='card col-3 col-md-3 container d-flex'>
                                        <div className='card-body'>
                                            <div className='mt-3'>
                                                <h4>Loan Options</h4>
                                                {/* amount of days left in loan period */}
            ...
            <div className='container d-lg-none mt-2'>
                {shelfCurrentLoans.length > 0 ?
                    <>
                        <h5 className='mb-5'>Current Loans: </h5>
