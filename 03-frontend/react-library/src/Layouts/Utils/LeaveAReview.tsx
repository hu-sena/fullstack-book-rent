...
export const LeaveAReview: React.FC<{ submitRreview: any }> = (props) => {
    ...
    function starValue(value: number) {
        setStarInput(value);
        // only when user has input rating stars, setDisplayInput appear
    ...
    return (
        <div className='dropdown' style={{ cursor: 'pointer' }}>
            ...
            {displayInput && <form method='POST' action='#'>
                ...
                <div>
                    <button className='btn btn-primary mt-3' onClick={() => props.submitRreview(starInput, reviewDescription)} type='button' >Submit Review</button>
                </div>
            </form>
            }
        </div>
